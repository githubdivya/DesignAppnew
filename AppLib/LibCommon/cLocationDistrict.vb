...
Public Class cLocationDistrict
    Inherits cBLBase
    ...
    Public Overridable Sub Update(ByRef ds As DataSet, Optional ByVal index As Object = 0, Optional ByVal enmwsIndex As Int16 = Nothing)
        ...
        With ds.Tables("Parameter")
            ...
            Next
        End With
        objDataExecute.Insert("COM_M_District_Update", objColCriteria, "District", Nothing)
    End Sub
    ...
    Public Overridable Sub Delete(ByVal strCriteria As String, Optional ByVal index As Object = 0, Optional ByVal enmwsIndex As Int16 = Nothing)
        Dim objColCriteria As New Collection
        objColCriteria.Add(New SqlParameter("DistrictID", SqlDbType.UniqueIdentifier, 16, ParameterDirection.Input, True, 0, 0, "DistrictID", DataRowVersion.Default, New System.Guid(strCriteria)))
        objDataExecute.Insert("COM_M_District_Delete", objColCriteria, "District", Nothing)
    ...
    Public Overridable Sub Insert(ByVal ds As DataSet, ByVal index As Object, Optional ByVal enmwsIndex As Int16 = Nothing)
        ...
        With ds.Tables("Parameter")
            ...
            Next
        End With
        objDataExecute.Insert("COM_M_District_Insert", objColCriteria, "District", Nothing)
    End Sub

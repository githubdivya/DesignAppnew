...
Public Class cArchival
    ...
    Public Overridable Sub GetDataSet(ByRef ds As DataSet, Optional ByVal index As Object = 0, Optional ByVal enmwsIndex As Int16 = Nothing)
        ...
        With ds.Tables("Parameter")
            ...
            Next
        End With
        objDataExecute.getDataSet(ds, "M_Archival_Select", objColCriteria, "Archival", Nothing)
    End Sub
    ...
    Public Overridable Sub Update(ByRef ds As DataSet, Optional ByVal index As Object = 0, Optional ByVal enmwsIndex As Int16 = Nothing)
        ...
        With ds.Tables("Parameter")
            ...
            Next
        End With
        objDataExecute.Insert("M_Archival_Update", objColCriteria, "Archival", Nothing)
    End Sub
    ...
    Public Overridable Sub Delete(ByVal strCriteria As String, Optional ByVal index As Object = 0, Optional ByVal enmwsIndex As Int16 = Nothing)
        Dim objColCriteria As New Collection
        objColCriteria.Add(New SqlParameter("Archival", SqlDbType.UniqueIdentifier, 16, ParameterDirection.Input, True, 0, 0, "ArchivalID", DataRowVersion.Default, New System.Guid(strCriteria)))
        objDataExecute.Insert("M_Archival_Delete", objColCriteria, "Archival", Nothing)
    ...
    Public Overridable Sub Insert(ByVal ds As DataSet, ByVal index As Object, Optional ByVal enmwsIndex As Int16 = Nothing)
        ...
        With ds.Tables("Parameter")
            ...
            Next
        End With
        objDataExecute.Insert("M_Archival_Insert", objColCriteria, "Archival", Nothing)
    End Sub

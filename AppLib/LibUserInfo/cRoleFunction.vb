...
Public Class cRoleFunction
    ...
    Public Overridable Sub GetDataSet(ByRef ds As DataSet, Optional ByVal index As Object = 0, Optional ByVal enmwsIndex As Int16 = Nothing)
        ...
        If ds.Tables.Contains("Parameter") = True Then
            ...
            End With
        End If
        objDataExecute.getDataSet(ds, "COM_RoleFuncMap_Select", objColCriteria, "FunctionMap", Nothing)
    End Sub
    ...
    Public Overridable Sub Update(ByRef ds As DataSet, Optional ByVal index As Object = 0, Optional ByVal enmwsIndex As Int16 = Nothing)
        ...
        objDataExecute.UpdateRec("COM_RoleFuncMap_Update", objColCriteria, "FunctionMap", Nothing)
    End Sub
    ...
    Public Overridable Sub Insert(ByVal ds As DataSet, ByVal index As Object, Optional ByVal enmwsIndex As Int16 = Nothing)
        ...
        objDataExecute.Insert("COM_RoleFuncMap_Insert", objColCriteria, "FunctionMap", Nothing)
        ...
        With dt.Rows(0)
            Select Case ParameterMode
                Case enmParameterMode.Insert
                    objColCriteria.Add(New SqlParameter("RoleFunctionMapID", SqlDbType.Int, 8, ParameterDirection.InputOutput, True, 8, 0, "RoleFunctionMapID", DataRowVersion.Default, .Item("RoleFunctionMapID")))
                Case enmParameterMode.Update
                    objColCriteria.Add(New SqlParameter("RoleFunctionMapID", SqlDbType.Int, 8, ParameterDirection.Input, False, 8, 0, "RoleFunctionMapID", DataRowVersion.Default, .Item("RoleFunctionMapID")))
            End Select
            ...
            objColCriteria.Add(New SqlParameter("checked", .Item("checked")))
        End With
    End Sub

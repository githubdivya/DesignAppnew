...
Public Class cRoleFunctionMap
    ...
    Public Overridable Sub GetDataSet(ByRef ds As DataSet, Optional ByVal index As Object = 0, Optional ByVal enmwsIndex As Int16 = Nothing)
        ...
        If ds.Tables.Contains("Parameter") = True Then
            ...
            End With
        End If
        objDataExecute.getDataSet(ds, "COM_D_UserFuncMap_Select", objColCriteria, "FunctionMap", Nothing)
    End Sub
    ...
    Public Overridable Sub Insert(ByVal ds As DataSet, ByVal index As Object, Optional ByVal enmwsIndex As Int16 = Nothing)
        ...
        objDataExecute.Insert("COM_D_UserFuncMap_Insert", objColCriteria, "FunctionMap", Nothing)

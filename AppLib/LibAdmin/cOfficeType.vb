...
Public Class cOfficeType
    ...
    '        Next
    '    End With
    '    objDataExecute.getDataSet(ds, "COM_OfficeInfo", objColCriteria, "COM_M_OfficeType",Nothing)
    'End Sub
    Public Overridable Sub GetDataSet(ByRef ds As DataSet, Optional ByVal index As Object = 0, Optional ByRef DBConnection As SqlConnection = Nothing, Optional ByVal enmwsIndex As Int16 = Nothing)
        ...
        With ds.Tables("Parameter")
            ...
            Next
        End With
        objDataExecute.getDataSet(ds, "COM_M_OfficeType_Select", objColCriteria, "COM_M_OfficeType", Nothing)
    End Sub
    Public Overridable Sub GetDataSet1(ByRef ds As DataSet, Optional ByVal index As Object = 0, Optional ByRef DBConnection As SqlConnection = Nothing, Optional ByVal enmwsIndex As Int16 = Nothing)
        Dim i As Integer
        Dim objColCriteria As New Collection
        With ds.Tables("Parameter")
            ...
            Next
        End With
        objDataExecute.getDataSet(ds, "COM_M_OfficeTypeChannelDetails_Select", objColCriteria, "COM_M_OfficeType", Nothing)
    End Sub
    ...
    Public Overridable Sub Update(ByRef ds As DataSet, Optional ByVal index As Object = 0, Optional ByRef DBConnection As SqlConnection = Nothing, Optional ByVal enmwsIndex As Int16 = Nothing)
        ...
        With ds.Tables("Parameter")
            ...
            Next
        End With
        objDataExecute.UpdateRec("COM_M_OfficeType_Update", objColCriteria, "COM_M_OfficeType", Nothing)
    End Sub
    ...
    Public Overridable Function Insert(ByVal ds As DataSet, ByVal index As Object, Optional ByRef DBConnection As SqlConnection = Nothing, Optional ByVal enmwsIndex As Int16 = Nothing) As String
        Dim i As Integer
        Dim objColCriteria As New Collection
        objColCriteria.Add(New SqlParameter("OfficeTypeId", SqlDbType.Int, 4, ParameterDirection.InputOutput, True, 4, 0, "OfficeTypeId", DataRowVersion.Default, DBNull.Value))
        With ds.Tables("Parameter")
            For i = 0 To .Rows.Count - 1
                objColCriteria.Add(New SqlParameter(.Rows(i).Item("PName").ToString, .Rows(i).Item("Pvalue")))
            Next
        End With
        objDataExecute.Insert("COM_M_OfficeType_Insert", objColCriteria, "COM_M_OfficeType", Nothing)

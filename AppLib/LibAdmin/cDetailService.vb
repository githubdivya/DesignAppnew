...
Public Class cDetailService
    ...
    Public Overridable Sub GetDataSet(ByRef ds As DataSet, Optional ByVal index As Object = 0, Optional ByRef DBConnection As SqlConnection = Nothing, Optional ByVal enmwsIndex As Int16 = Nothing)
        ...
        With ds.Tables("Parameter")
            ...
            Next
        End With
        objDataExecute.getDataSet(ds, "GP_5_PortalService_Detail_Select", objColCriteria, "GP_5_PortalService_Detail", Nothing)
    End Sub
    ...
    Public Overridable Sub Update(ByRef ds As DataSet, Optional ByVal index As Object = 0, Optional ByRef DBConnection As SqlConnection = Nothing, Optional ByVal enmwsIndex As Int16 = Nothing)
        ...
        With ds.Tables("Parameter")
            ...
            Next
        End With
        objDataExecute.Insert("GP_5_PortalService_Detail_Update", objColCriteria, "GP_5_PortalService_Detail", Nothing)
    End Sub
    ...
    Public Overridable Function Insert(ByVal ds As DataSet, ByVal index As Object, Optional ByRef DBConnection As SqlConnection = Nothing, Optional ByVal enmwsIndex As Int16 = Nothing) As String
        Dim i As Integer
        Dim objColCriteria As New Collection
        objColCriteria.Add(New SqlParameter("PortalServiceDetailID", SqlDbType.Int, 4, ParameterDirection.InputOutput, True, 4, 0, "PortalServiceDetailID", DataRowVersion.Default, DBNull.Value))
        With ds.Tables("Parameter")
            For i = 0 To .Rows.Count - 1
                objColCriteria.Add(New SqlParameter(.Rows(i).Item("PName").ToString, .Rows(i).Item("Pvalue")))
            Next
        End With
        objDataExecute.Insert("GP_5_PortalService_Detail_Insert", objColCriteria, "GP_5_PortalService_Detail", Nothing)

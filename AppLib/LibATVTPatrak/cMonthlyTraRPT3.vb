...
Public Enum enmRPT_T_MonthlyTransactionRPT3
    RPT_T_MonthlyTransactionRPT3 = 1
End Enum

Public Class cMonthlyTransactionRPT3
    ...
    Public Overridable Sub GetDataSet(ByRef ds As DataSet, Optional ByVal index As Object = 0, Optional ByVal enmwsIndex As Int16 = Nothing)
        Try
            ...
            With ds.Tables("Parameter")
                ...
                Next
            End With
            objDataExecute.getDataSet(ds, "MonthlyTransactionRPT3_Select", objColCriteria, "MonthlyTransactionRPT3", Nothing)
    ...
    Public Overridable Sub Update(ByRef ds As DataSet, Optional ByVal index As Object = 0, Optional ByVal enmwsIndex As Int16 = Nothing)
        Try
            ...
            With ds.Tables("Parameter")
                ...
                Next
            End With
            objDataExecute.Insert("RPT_T_MonthlyTransactionRPT3_Update", objColCriteria, "MonthlyTransactionRPT3", Nothing)
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
    Public Overridable Sub Delete(ByVal strCriteria As String, Optional ByVal index As Object = 0, Optional ByVal enmwsIndex As Int16 = Nothing)
        Try
            ...
            objDataExecute.Insert("RPT_T_MonthlyTransactionRPT3_Delete", objColCriteria, "cMonthlyTransactionRPT3", Nothing)
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
    Public Overridable Sub Insert(ByVal ds As DataSet, ByVal index As Object, Optional ByVal enmwsIndex As Int16 = Nothing)
        Try
            Dim objColCriteria As New Collection
            CreateParameter(ds.Tables("MonthlyTransactionRPT3"), objColCriteria, enmParameterMode.Insert)
            objDataExecute.Insert("MonthlyTransactionRPT3_Insert", objColCriteria, "MonthlyTransactionRPT3", Nothing)
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
    ...
    Private Sub CreateParameter(ByRef dt As DataTable, ByRef objColCriteria As Collection, ByVal ParameterMode As enmParameterMode)
        With dt.Rows(0)
            ...
            objColCriteria.Add(New SqlParameter("ApproveGrant", .Item("ApproveGrant")))
            objColCriteria.Add(New SqlParameter("AllocateGrant", .Item("AllocateGrant")))
            objColCriteria.Add(New SqlParameter("UsedGrant", .Item("UsedGrant")))
            objColCriteria.Add(New SqlParameter("unusedGrant", .Item("unusedGrant")))
            objColCriteria.Add(New SqlParameter("WorkDetails", .Item("WorkDetails")))
            objColCriteria.Add(New SqlParameter("WorkDetailsStatus", .Item("WorkDetailsStatus")))
            objColCriteria.Add(New SqlParameter("PendingWork", .Item("PendingWork")))
            objColCriteria.Add(New SqlParameter("WorkDetailsPercentage", .Item("WorkDetailsPercentage")))
            objColCriteria.Add(New SqlParameter("PendingWorkTime", .Item("PendingWorkTime")))

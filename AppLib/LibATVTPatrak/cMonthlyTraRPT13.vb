...
Public Enum enmRPT_T_MonthlyTransactionRPT13
    RPT_T_MonthlyTransactionRPT13 = 1
End Enum

Public Class cMonthlyTransactionRPT13
    ...
    Public Overridable Sub GetDataSet(ByRef ds As DataSet, Optional ByVal index As Object = 0, Optional ByVal enmwsIndex As Int16 = Nothing)
        Try
            ...
            With ds.Tables("Parameter")
                ...
                Next
            End With
            objDataExecute.getDataSet(ds, "MonthlyTransactionRPT13_Select", objColCriteria, "MonthlyTransactionRPT13", Nothing)
    ...
    Public Overridable Sub Insert(ByVal ds As DataSet, ByVal index As Object, Optional ByVal enmwsIndex As Int16 = Nothing)
        Try
            Dim objColCriteria As New Collection
            CreateParameter(ds.Tables("MonthlyTransactionRPT13"), objColCriteria, enmParameterMode.Insert)
            objDataExecute.Insert("MonthlyTransactionRPT13_Insert", objColCriteria, "MonthlyTransactionRPT13", Nothing)
        Catch ex As Exception
            Throw ex
        End Try
    End Sub

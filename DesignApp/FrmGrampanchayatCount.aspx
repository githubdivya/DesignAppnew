<%@ Page Title="" Language="vb" AutoEventWireup="false" CodeBehind="FrmGrampanchayatCount.aspx.vb" Inherits="DesignApp.FrmGrampanchayatCount" %>
    ...
    <form runat="server">
        <section class="pb-2">
            <div class="container">
                ...
                <div class="gvFrmGrampanchayatCount">
                    <asp:GridView ID="gvFrmGrampanchayatCount" runat="server" AutoGenerateColumns="false" CellPadding="10" CssClass="table table-striped" Width="1279px">
                        <Columns>
                            ...
                            <asp:BoundField DataField="TalukaName" HeaderText="Taluka Name" />
                            <asp:BoundField DataField="OfficeName_E" HeaderText="GramPanchayat Office" />
                        </Columns>
                    </asp:GridView>
                </div>

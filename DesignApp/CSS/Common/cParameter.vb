...
<Serializable()> Public Class cParameter
    ...
    End Sub
    Sub New(ByRef ds As DataSet, ByVal strTableName As String)
        strDBTableName = strTableName
        If ds.Tables.Contains(strDBTableName) Then
            ds.Tables.Remove(strDBTableName)
        End If
        Dim objdsTable As New System.Data.DataTable
        objdsTable.TableName = strTableName
        ds.Tables.Add(objdsTable)
    End Sub
    ...
    Public Function AddColumnswithValue(ByRef ds As DataSet, ByVal strColumnsName As String) As Integer
        ds.Tables(strDBTableName).Columns.Add(strColumnsName)
    End Function
